...
# 2. Write a Python program to find the maximum number in a list using the `reduce` function.

from functools import reduce

list_of_numbers = [3, 5, 2, 8, 1]
print(f"Maximum Value: {reduce(lambda x,y: x if x >= y else y, list_of_numbers)}")
print()  # Just to add a newline for better readability
